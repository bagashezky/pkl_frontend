...
const Header = (props) => {
  ...
  const links = [
    { id: 1, route: 'Beranda', url: '#' },
    { id: 2, route: 'Dashboard', url: '#' },
    { id: 3, route: 'Dataset', url: '#' },
    { id: 4, route: 'Ketahanan Pangan', url: '#' },
    { id: 5, route: 'Peternakan', url: '#' }
  ];
          ...
          <Toolbar className={classes.toolBar}>
            <Link href="#" underline="none">
              <Typography variant="h5" className={classes.logo}>
                <img src={LogoSimawas} alt="logosimawas" />
              </Typography>
            </Link>
